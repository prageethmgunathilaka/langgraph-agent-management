...
from ..models.schemas import (
    ...
    TaskStatus, IntelligenceLevel, TaskExecution, WorkflowPlan
)
    ...
    async def _execute_step(self, 
        ...
        try:
            ...
            return {
                "status": "completed",
                "result": result,
                "execution_time": (execution.completed_at - execution.started_at).total_seconds() if execution.completed_at and execution.started_at else 0
            }
