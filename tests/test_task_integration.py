...
class TestTask6Integration:
    ...
    def test_workflow_execution_with_different_intelligence(self):
        ...
        request_data = {
            "request": "Process user registration data",
            "intelligence_level": "BASIC"
        }
    ...
    def test_workflow_status_tracking(self):
        ...
        request_data = {
            "request": "Create a data validation function",
            "intelligence_level": "BASIC"
        }
    ...
    def test_task_status_tracking(self):
        ...
        request_data = {
            "request": "Create a simple calculator function",
            "intelligence_level": "BASIC"
        }
    ...
    def test_task_cancellation(self):
        ...
        # Create and execute workflow
        request_data = {
            "request": "Create a long-running data processing task",
            "intelligence_level": "BASIC"
        }
    ...
    def test_llm_usage_after_intelligent_workflow(self):
        ...
        request_data = {
            "request": "Create a complex data analysis system",
            "intelligence_level": "INTELLIGENT"
        }
    ...
    def test_complete_workflow_lifecycle(self):
        ...
        request_data = {
            "request": "Create a user registration API with validation",
            "intelligence_level": "INTELLIGENT"
        }
    ...
    def test_multiple_concurrent_workflows(self):
        ...
        for i in range(3):
            request_data = {
                "request": f"Create test function {i}",
                "intelligence_level": "BASIC"
            }
