...
from app.utils.errors import WorkflowNotFoundError, WorkflowAlreadyExistsError, WorkflowDeletionError, handle_service_error
...
class WorkflowService(LoggerMixin):
    ...
    async def create_workflow(self, workflow_data: WorkflowCreate) -> WorkflowResponse:
        ...
        log_workflow_event(workflow_id, "created", {"name": workflow.name, "description": workflow.description})
    ...
    async def delete_workflow(self, workflow_id: str, agent_service=None) -> bool:
        ...
        try:
            ...
            log_workflow_event(workflow_id, "deleted", {"name": workflow.name, "agent_count": workflow.agent_count})
    ...
    async def update_workflow_status(self, workflow_id: str, status: WorkflowStatus) -> bool:
        ...
        log_workflow_event(workflow_id, "status_changed", {"old_status": old_status, "new_status": status})
