...
from .task_service import TaskExecution, WorkflowPlan, TaskStatus, IntelligenceLevel
    ...
    async def save_task_execution(self, execution: TaskExecution) -> bool:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                llm_interactions_json = json.dumps(execution.llm_interactions)
                ...
                """, (
                    execution.task_id,
                    execution.agent_id,
                    getattr(execution, 'workflow_id', None),
